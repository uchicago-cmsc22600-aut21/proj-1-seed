...
structure Options : sig
  ...
  (* debugging / grading support options *)
    ...
    val withMarks : bool ref    (* include source marks when dumping the parse tree *)
    val dumpAST : bool ref      (* dump AST *)
    val checkSimple : bool ref	(* check SimpleAST invariants *)
    val dumpSimple : bool ref   (* dump Simple AST *)
    val dumpOpt : bool ref      (* dump Optimized Simple AST *)
  ...
  (* print a usage message to standard output *)
    fun usage' sts = (
          print
            ...
            \      --marks        include source marks in parse-tree output\n\
